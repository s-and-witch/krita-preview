...
const selectZoomLevelCommandId = '_kritaPreview.selectZoomLevel';
...
export class ZoomStatusBarEntry extends OwnedStatusBarEntry {
	...
	constructor() {
		super('status.kritaPreview.zoom', vscode.l10n.t("Image Zoom"), vscode.StatusBarAlignment.Right, 102 /* to the left of editor size entry (101) */);
